CREATE OR REPLACE PROCEDURE w_data.INSERISCI_SPESA_FISSA(
	data_mov date,
	id_conto int,
	importo real,
	descrizione text,
...
BEGIN
	...
	INSERT INTO w_data.SPESE_FISSE(ID_MOV, MESE, DESCRIZIONE) 
		VALUES (id_mov_main, current_month, descrizione);
